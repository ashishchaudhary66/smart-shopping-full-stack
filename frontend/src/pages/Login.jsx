...
export default function Login() {
  ...
  async function submitHandler(event) {
    ...
    try {
      ...
      if (response.ok) {
        // Dispatch Redux action and navigate if login is successful
        ...
        <form onSubmit={submitHandler} className="mt-6">
          ...
          <div className="mt-6">
            <button
              type="submit"
              disabled={loading}
              className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-green-500 rounded-md hover:bg-green-400 focus:outline-none focus:bg-green-400"
            >
